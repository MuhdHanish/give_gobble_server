...
const signupStepOne = (ngoRepository) => (username, email) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield ngoRepository.findByUsernameAndEmail(username, email);
        if (user) {
