...
const adminRepository_1 = require("../../../../framework/repository/adminRepository");
const adminModel_1 = require("../../../../framework/database/models/adminModel");
const adminLogin_1 = require("../../../../app/usecases/admin/adminAuthentication/adminLogin");
const adminRepository = (0, adminRepository_1.adminRepositoryEmpl)(adminModel_1.adminModel);
const loginController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield (0, adminLogin_1.adminLogin)(adminRepository)(identifier, password);
        if (user) {
