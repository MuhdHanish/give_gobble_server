...
const signupStepOne_1 = require("../../../../../app/usecases/restaurant/restaurantAuthentication/restaurantSignup/signupStepOne");
...
const stepOneController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { message, uId } = yield (0, signupStepOne_1.signupStepOne)(restaurantRepository)(username, email);
        if (uId) {
